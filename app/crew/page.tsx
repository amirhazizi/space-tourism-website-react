...
export default function Crew() {
  ...
  return (
    <main className='crew-main min-h-screen grid place-items-center'>
      <div className='pt-28 pb-10 md:pt-32 md:pb-0 text-clPrimary_3 font-barlowCondensed'>
          ...
          <div className='lg:grid space-y-10 lg:w-2/3'>
            ...
            <div className='space-y-10 text-center lg:text-left'>
              ...
              <div className='space-y-5 pb-7'>
                ...
                <p
                  className={`text-clPrimary_2 text-lg px-5 leading-7 md:leading-8 md:mx-auto lg:px-0 lg:mx-0 md:${
                    index === 0 ? "max-w-md" : "max-w-xl"
                  } lg:${index === 0 ? "max-w-md" : "max-w-lg"} `}
                >
                  {bio}
                </p>
              </div>
